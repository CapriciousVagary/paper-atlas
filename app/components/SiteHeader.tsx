...
export function SiteHeader({ active = "library" }: { active?: "library" | "browse" | "index" | "search" | "groups" | "upload" | "admin" }) {
  return (
    <header className="site-header">
      ...
      <nav className="main-nav" aria-label="主导航">
        ...
        <Link className={active === "browse" ? "active" : ""} href="/browse">分类浏览</Link>
